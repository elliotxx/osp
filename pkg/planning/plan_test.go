	...
	t.Run("content generation", func(t *testing.T) {
		...
		sections := []struct {
			...
			{"header", []string{
				"## Overview",
				"- Progress: █████░░░░░░░░░ 33%",
				"- [Total Issues: 3](https://github.com/elliotxx/osp/issues?q=is%3Aissue+milestone%3Av1.0.0)",
				"  - ✅ [Completed: 1](https://github.com/elliotxx/osp/issues?q=is%3Aissue+is%3Aclosed+milestone%3Av1.0.0)",
				"  - 🚧 [In Progress: 2](https://github.com/elliotxx/osp/issues?q=is%3Aissue+is%3Aopen+milestone%3Av1.0.0)",
			...
			{"footer", []string{
				"## Links",
				"- 📋 [Issues without priority](https://github.com/elliotxx/osp/issues?q=is%3Aopen+is%3Aissue+milestone%3Av1.0.0+-label%3Apriority/high+-label%3Apriority/medium+-label%3Apriority/low)",
				"- 👥 [Unassigned issues](https://github.com/elliotxx/osp/issues?q=is%3Aopen+is%3Aissue+milestone%3Av1.0.0+no%3Aassignee)",
				"- 📊 [All milestone issues](https://github.com/elliotxx/osp/milestones/1)",
				"---",
